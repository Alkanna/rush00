...
<input style="margin-top:30px" type="text" id="login" class="fadeIn second" name="login" placeholder="Username"/>
        <input required type="password" id="password" class="fadeIn third" name="password" placeholder="Password" />
        <input style="margin-top:35px;margin-bottom:30px;" type="submit" name="submit" class="fadeIn fourth" value="submit" />
        <?php if (auth_admin() == 1) : ?>
